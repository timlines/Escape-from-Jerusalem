...
const NPCS: Dictionary = {
	"merchant": {
		...
		"starting_trust": 2,
		"home_zone": "marketplace",
		"schedule": {
			"Morning": ["marketplace"], "Afternoon": ["marketplace"],
			"Evening": ["marketplace"], "Night": ["marketplace"],
		},
		...
		"ask_topics": [
			{
				...
				"reveal_claim": "Was seen at the Marketplace earlier today.",
	...
	"potter": {
		...
		"starting_trust": 2,
		"home_zone": "lower_city",
		"schedule": {
			"Morning": ["lower_city"], "Afternoon": ["lower_city"],
			"Evening": ["lower_city"], "Night": ["lower_city"],
		},
		...
		"ask_topics": [
			{
				...
				"requires_fact": "", "min_trust": 0,
				"lines": ["Laban? I've known him for years.", "He keeps to habits -- often up in the Upper City in the afternoons, seeing to his business."],
				"repeat_lines": ["Still the same habits, far as I know. Upper City, most afternoons."],
				"reveals_fact": "f_laban_pattern_stable", "reveal_subject": "Laban",
				"reveal_claim": "Often goes to the Upper City in the afternoon.",
				"reveal_status": "Reported", "trust_delta": 0,
			},
			{
				"id": "ask_stone_house", "label": "Ask who knows Laban well",
				"requires_fact": "", "min_trust": 1,
				"lines": ["There's a woman up in the Upper City who's known Laban longer than most of us.", "If anyone understands the man, it's her."],
				"repeat_lines": ["The Upper City. That's still where I'd send you."],
	...
	"stable_worker": {
		...
		"home_zone": "lower_city",
		"schedule": {
			"Morning": ["lower_city", "lower_city", "marketplace"], "Afternoon": ["lower_city"],
			"Evening": ["lower_city", "lower_city", "marketplace"], "Night": ["lower_city"],
		},
		...
		"ask_topics": [
			{
				...
				"reveal_claim": "Was seen in the Lower City.", "reveal_status": "Rumor", "trust_delta": 0,
			},
			{
				"id": "ask_laban_direction", "label": "Ask which way he went",
				"requires_fact": "", "requires_favor": "mend_bridle", "min_trust": 0,
				"lines": ["Since you asked proper -- he headed off toward the back alleys, and hasn't been back since."],
				"repeat_lines": ["Toward the alleys. That's the last I saw of him."],
				"reveals_fact": "f_laban_stable_direction", "reveal_subject": "Laban",
				"reveal_claim": "Headed off toward the back alleys and hasn't returned.",
				"reveal_status": "Reported", "trust_delta": 0,
			},
		],
		"tell_reactions": {},
	...
	"guard_older": {
		...
		"modulate": Color(1, 1, 1, 1),
		"starting_trust": 2,
		"home_zone": "upper_city",
		"schedule": {
			"Morning": ["upper_city"], "Afternoon": ["upper_city"],
			"Evening": ["upper_city"], "Night": ["upper_city"],
		},
		...
		"ask_topics": [
			{
				...
				"requires_fact": "", "min_trust": 0,
				"lines": ["Laban? Aye, he passed through maybe twenty minutes ago, heading toward the Temple District."],
				"repeat_lines": ["Twenty minutes or so, like I told you. Heading toward the Temple District."],
				"reveals_fact": "f_laban_gate_recent", "reveal_subject": "Laban",
				"reveal_claim": "Passed through the gate about twenty minutes ago, heading toward the Temple District.",
				"reveal_status": "Reported", "trust_delta": 0,
			},
		],
		"tell_reactions": {},
	...
	"guard_younger": {
		...
		"lie": {
			...
			"lines": [
				...
				"\"Didn't hear it from me, but he keeps company up in the Upper City some nights.\"",
			],
			"reveals_fact": "f_laban_hint_stonehouse", "reveal_subject": "Laban",
			"reveal_claim": "Rumored to keep company in the Upper City some nights.",
			"reveal_status": "Rumor",
	...
	"shepherd": {
		...
		"starting_trust": 2,
		"home_zone": "temple_district",
		"schedule": {
			"Morning": ["temple_district", "temple_district", "alleys"], "Afternoon": ["alleys", "temple_district"],
			"Evening": ["temple_district"], "Night": ["temple_district", "upper_city"],
		},
		...
		"ask_topics": [
			...
			},
			{
				...
				"lines": ["A man in a dark cloak went by, heading through the alleys.", "Didn't look back once."],
				"repeat_lines": ["Through the alleys. That's all I saw of him."],
				"reveals_fact": "f_cloak_seen_north", "reveal_subject": "Laban",
				"reveal_claim": "A man in a dark cloak was seen heading through the back alleys.",
				"reveal_status": "Reported", "trust_delta": 0,
			},
		],
		"tell_reactions": {},
	...
	"courier": {
		...
		"home_zone": "alleys",
		"schedule": {
			"Morning": ["alleys", "marketplace"], "Afternoon": ["marketplace", "alleys"],
			"Evening": ["alleys", "alleys"], "Night": ["alleys", "marketplace"],
		},
		...
		"ask_topics": [
			{
				"id": "ask_caravan", "label": "Ask about the road out of the city",
				"requires_fact": "", "requires_favor": "deliver_word", "min_trust": 0,
				"lines": ["There's talk of a caravan gathering just past the Temple District gate these next few days.", "If Laban means to leave the city, that's where he'd go."],
				"repeat_lines": ["Caravan's still gathering past the Temple gate. That's where I'd look."],
				"reveals_fact": "f_courier_route", "reveal_subject": "Laban",
				"reveal_claim": "A caravan is gathering near the Temple District gate -- likely where he'd go if he left the city.",
				"reveal_status": "Reported", "trust_delta": 0,
			},
		],
		"tell_reactions": {},
	...
	"laban_companion": {
		...
		"home_zone": "upper_city",
		"schedule": {
			"Morning": ["marketplace", "lower_city"], "Afternoon": ["lower_city", "marketplace"],
			"Evening": ["upper_city", "alleys"], "Night": ["upper_city", "upper_city", "alleys"],
		},
	...
	"laban": {
		...
		"home_zone": "marketplace",
		"schedule": {
			"Morning": ["marketplace", "upper_city"], "Afternoon": ["upper_city", "marketplace", "upper_city"],
			"Evening": ["upper_city", "alleys"], "Night": ["laban_storeroom", "upper_city", "laban_storeroom"],
		},
...
func get_home_zone(npc_id: String) -> String:
	return String(NPCS.get(npc_id, {}).get("home_zone", "family_home"))
