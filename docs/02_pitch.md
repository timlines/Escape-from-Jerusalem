...
> **“What if I actually had to live through the stories I've read?”**
...
An NPC might know something important—but only reveal it if approached correctly.

A location might contain a clue.

An apparently insignificant conversation might unlock another solution.
...
The player continually builds a mental model of the world.
...
That distinction is at the heart of the game.
...
The city is divided into interconnected areas—including the **Upper City, Lower City, markets, residential areas, and other important locations**.

The player can approach problems from multiple directions.
...
This mission is deliberately chosen because it demonstrates the fundamental gameplay philosophy.

The player must:

* Explore Jerusalem.
* Learn about the people and locations around them.
...
> **“Is this a fun way to experience these stories?”**

If the answer is yes, the same underlying systems can support the rest of the game.
...
*Escape from Jerusalem* explores what happens when sacred and historical narratives are transformed into interactive worlds.

Rather than simply retelling the story, the game asks players to inhabit it.

The goal isn't to tell players:

> “Nephi did this.”

The goal is to let the player experience:

> **“I am Nephi. What would I do?”**

That creates a fundamentally different relationship with the source material.
...
*Escape from Jerusalem* can establish a framework for creating **interactive stories from the Book of Mormon**.

Each story could become its own playable experience while sharing a common philosophy and technology.

The result could eventually become a collection of interconnected narrative games exploring different characters, locations, and periods.
...
### 1. Is the world interesting to explore?

Can a historically inspired city become a compelling gameplay space?

### 2. Can information become gameplay?

Can conversations, observation, schedules, and environmental clues create meaningful player decisions?

### 3. Can familiar stories become interactive experiences?

Can players experience a story they may already know in a way that feels new?

If the prototype succeeds, the next step is expanding the systems into a larger vertical slice and eventually a complete game.
